...
{
    public class Socilist
    {
        public Socilist(int id,
          string nif,
          string nom,
          string cognom1,
          string cognom2,
       //   DateTime dataAlta,
        ...
        //public Socilist(int numero, string nif, string nom, string cognom1, string cognom2, DateTime dataAlta, string passwordHash, int estadistica)
        //{
        //    this.numero = numero;
        //    Nif = nif;
        //    Nom = nom;
